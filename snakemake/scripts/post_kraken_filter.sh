prefix=$1
DB="/sc/arion/projects/schzrnas/zhangy40/softwares/kuniq_microbialdb_minus_kdb.20230808"
...
cat $prefix.krakenuniq.info_collection|awk '/d__/ && !/synthetic/ && !/Homo sapiens/' \
	> $prefix.krakenuniq.info_collection.flt
less $prefix.krakenuniq.info_collection.flt|awk '{print $1"\n"$2}' > $prefix.krakenuniq.microbiome.fasta
